...
requirements = python3,kivy,firebase-admin,google-api-python-client,cachetools,protobuf,pyasn1,rsa,google-auth,google-auth-httplib2,httplib2,requests,urllib3,certifi,idna,charset-normalizer
